...
// };
// TODO:: temp func
const validateDashboardId = async (): Promise<boolean> => true;
...
export default {
    ...
    setup(props) {
        const state = reactive({
            ...
            // TODO:: change homeDashboardId
            homeDashboardId: computed<string|undefined>(() => 'project_01_1'),
            visiblePdfDownload: false,
            previewItems: [] as Item[],
            pdfFileName: computed<string>(() => `${state.dashboard.name ?? 'Dashboard'}_${dayjs().format('YYYYMMDD')}`),
            ...
            // TODO:: connect dashboardList
            dashboardList: computed<Array<any>>(() => []),
            // dashboardListLoading: computed(() => costExplorerStore.state.dashboardListLoading),
            // TODO:: dashboardListLoading + widget loading ?
            dashboardListLoading: computed<boolean>(() => false),
        });
